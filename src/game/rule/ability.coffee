ability_matrix =
  ...
  king:        [      3,        5,       [3, 0.1],   [10, 0.1],    1000,          60,      0.1,         0.1]
  queen:       [      3,       20,       [10,  0],   [50, 0.1],     100,          50,      0.1,         0.2]
  rook:        [     20,       30,       [1, 0.1],    [5, 0.1],     600,          90,        0,           0]
  bishop:      [     12,       20,       [1, 0.1],    [1, 0.1],     450,          60,        0,           0]
  knight:      [      3,        5,       [1, 0.1],    [1, 0.1],     400,          50,        0,           0]
  pawn:        [      6,       12,       [1, 0.1],      [0, 0],     240,          80,        0,           0]
  super_pawn:  [      7,       14,       [1, 0.1],      [0, 0],     300,          70,        0,           0]
  cannon:      [    100,       90,       [0,   0],      [0, 0],     500,          60,        0,           0]
