...
(function() {
  // piece move preview
  var abort_preview, default_pick_condition, disable, get_pick_condition, hovering_coord, init, last_mouse_position, launch_preview, on_drop, on_hover, on_mousedown, on_mousemove, on_mouseup, on_pick, paint_previewing_piece, pick_condition, preview, preview_condition, previewing, previewing_color, previewing_coord, previewing_dropping_coord, previewing_piece, set_color, update_mouse_position, view_info, view_info_coord, view_spawntime;
  ...
  preview = function(evt) {
    var destination_coord, i, j, k, len, len1, len2, mo, moves, mr, ref, ref1, ref2;
    ...
    if (!calc.coord_equal(previewing_dropping_coord, previewing_coord)) {
      return paint.mark_grid(ui.ctx.static, previewing_dropping_coord, shape.style_dark_green);
    }
  };
  ...
  // view game status
  view_spawntime = function() {
    var i, len, msg, p, ref, secs, ticks;
    ...
    return ui.spawntime.value = msg.join('\n');
  };
  ...
  init = function() {
    ...
    return ev.hook('render', view_spawntime);
  };

  window.preview = {init, set_color, disable};
