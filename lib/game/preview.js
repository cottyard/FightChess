...
(function() {
  // piece move preview
  var abort_preview, default_pick_condition, disable, get_pick_condition, hovering_coord, init, last_mouse_position, launch_preview, on_drop, on_hover, on_mousedown, on_mousemove, on_mouseup, on_pick, paint_previewing_piece, pick_condition, preview, preview_condition, previewing, previewing_color, previewing_coord, previewing_piece, set_color, update_mouse_position, view_info, view_info_coord, view_spawntime;
  ...
  view_spawntime = function() {
    ...
    return ui.spawntime.value = `pawn spawns in: ${secs} seconds`;
  };
