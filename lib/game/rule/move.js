...
(function() {
  var add_defensive_move, add_offensive_move, add_regular_move, bishop, bishop_extra_moves, bishop_moves_orients, is_in_board, is_in_range, king, king_moves_deltas, knight, knight_moves_deltas, pawn, queen, rook, rook_moves_orients, super_pawn, super_pawn_atk_ast_deltas, super_pawn_moves_deltas, valid_moves,
    indexOf = [].indexOf;
