...
(function() {
  ...
  coord_one_of = function(coord, coord_list) {
    var c, i, len;
    for (i = 0, len = coord_list.length; i < len; i++) {
      c = coord_list[i];
  ...
  window.calc = {coord_to_pos, pos_to_coord, coord_equal, coord_one_of, get_segment_angle, shrink_segment, randint, pick_one, remove_item_from_array, copy_array, to_string, from_string, set_type, obj_to_arraybuffer, arraybuffer_to_obj, wrap_float_for_arraybuffer, unwrap_float_from_arraybuffer};
