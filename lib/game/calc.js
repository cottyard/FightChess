...
(function() {
  var arraybuffer_to_obj, coord_equal, coord_one_of, coord_to_pos, copy_array, from_string, get_segment_angle, hoop, obj_to_arraybuffer, pos_to_coord, randint, read_from_buffer, remove_item_from_array, set_type, shrink_segment, sum_byte_spec_size, to_string, unwrap_float_from_arraybuffer, wrap_float_for_arraybuffer, write_to_buffer;

  wrap_float_for_arraybuffer = function(num, precision) {
    if (precision == null) {
      precision = 0.1;
    }
  ...
  unwrap_float_from_arraybuffer = function(num, precision) {
    if (precision == null) {
      precision = 0.1;
    }
  ...
  window.calc = {
    ...
    set_type: set_type,
    obj_to_arraybuffer: obj_to_arraybuffer,
    arraybuffer_to_obj: arraybuffer_to_obj,
    wrap_float_for_arraybuffer: wrap_float_for_arraybuffer,
    unwrap_float_from_arraybuffer: unwrap_float_from_arraybuffer
  };
