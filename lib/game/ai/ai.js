...
(function() {
  var activate, ai_color, ai_current, deactivate, get_value_from_buttons, init, on_think, set_ai, set_interval, think_interval, thinking_cooldown;
  ...
  init = function() {
    ...
    return set_interval(interval);
  };

  get_value_from_buttons = function(radio_buttons) {
    var button, i, len;
    for (i = 0, len = radio_buttons.length; i < len; i++) {
