...
(function() {
  var arrow, clear_canvas, line, rectangle, restore_style, save_style, saved_fillstyle, saved_linewidth, saved_strokestyle, set_linewidth, set_style, style_blue, style_blue_tp, style_brown, style_cerulean_tp, style_dark_green, style_green_tp, style_grey, style_light, style_red_tp, style_tp, style_white, text, triangle;

  arrow = function(ctx, x, y, to_x, to_y, size = 5, width = null, overlap_offset = 0) {
    var _, angle, line_x, line_y;
    if (overlap_offset > 0) {
  ...
  line = function(ctx, x, y, to_x, to_y, width = null) {
    if (width != null) {
      ctx.lineWidth = width;
    }
    ctx.beginPath();
  ...
  window.shape = {arrow, line, triangle, rectangle, text, clear_canvas, set_style, save_style, restore_style, style_red_tp, style_green_tp, style_blue_tp, style_white, style_brown, style_blue, style_grey, style_light, style_tp, style_cerulean_tp, style_dark_green};
