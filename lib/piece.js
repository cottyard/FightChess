...
(function() {
  ...
  Piece = (function() {
    ...
    Piece.prototype.inflict = function(hp_damage) {};

    Piece.prototype.enhance = function(shield) {};
    ...
    Piece.prototype.die = function() {
      if (this.is_onboard()) {
        this.board.lift_piece(this.coordinate);
        return this.coordinate = [-1, -1];
      }
    };

    Piece.prototype.info = function() {
      return "hp: " + this.hp + "/" + this.hp_total + "\nshield: " + this.shield + "/" + this.shield_total + " (" + this.shield_heal + ")";
    };
