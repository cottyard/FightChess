...
(function() {
  var arrow, clear_canvas, line, rectangle, restore_style, save_style, saved_fillstyle, saved_strokestyle, set_style, style_blue, style_blue_tp, style_brown, style_green_tp, style_red_tp, style_tp, text, triangle;
  ...
  save_style = function(ctx) {
    ...
    return saved_fillstyle = ctx.fillStyle;
  };

  restore_style = function(ctx) {
    ctx.strokeStyle = saved_strokestyle;
    return ctx.fillStyle = saved_fillstyle;
  };
