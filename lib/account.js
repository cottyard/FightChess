...
(function() {
  ...
  on_login_clicked = function() {
    ...
    return peer_server.login(id, on_login_succeeded, on_login_failed);
  };
  ...
  on_challenge_clicked = function() {
    ...
    return peer_server.connect(id, on_challenge_accepted, on_challenge_failed);
  };

  on_login_succeeded = function() {
    set_ui_state_after_log_in();
    return peer_server.wait(on_challenged);
  };
