...
(function() {
  ...
  on_pick = function(evt) {
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      mo = _ref1[_j];
      _results.push(paint.mark_grid(game.ctx["static"], mo, shape.style_red_tp));
    }
    return _results;
  };
  ...
  on_hover = function(evt) {
    ...
    if (picking_piece || board.chess_board.is_occupied(evt.coord)) {
      return game.cvs.animate.style.cursor = "pointer";
    } else {
      return game.cvs.animate.style.cursor = "default";
    }
  };
  ...
  on_mousemove = function(evt) {
    ...
    return paint.piece_at(game.ctx.animate, picking_piece, evt.pos);
  };
